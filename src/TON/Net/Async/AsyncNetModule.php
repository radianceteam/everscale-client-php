...
class AsyncNetModule implements NetModuleAsyncInterface
{
     ...
     * @return AsyncResultOfSubscribeCollection
     */
    public function subscribeAsync(ParamsOfSubscribe $params): AsyncResultOfSubscribeCollection
    {
        return new AsyncResultOfSubscribeCollection($this->_context->callFunctionAsync('net.subscribe', $params));
    }
