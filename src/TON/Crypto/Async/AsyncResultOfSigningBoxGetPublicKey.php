...
use TON\Crypto\ResultOfSigningBoxGetPublicKey;
use TON\JoinableInterface;
use TON\TonClientException;
use TON\TonRequest;

class AsyncResultOfSigningBoxGetPublicKey implements AsyncInterface
{
    /** TON request handle. */
    private TonRequest $_request;

    /**
     * AsyncResultOfSigningBoxGetPublicKey constructor.
     ...
     * @return ResultOfSigningBoxGetPublicKey Function execution result.
     * @throws TonClientException Function execution error.
     */
    public function await(int $timeout = -1): ResultOfSigningBoxGetPublicKey
    {
        return new ResultOfSigningBoxGetPublicKey($this->_request->await($timeout));
    }
