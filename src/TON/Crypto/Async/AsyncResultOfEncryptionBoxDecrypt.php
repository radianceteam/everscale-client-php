...
use TON\Crypto\ResultOfEncryptionBoxDecrypt;
use TON\JoinableInterface;
use TON\TonClientException;
use TON\TonRequest;

class AsyncResultOfEncryptionBoxDecrypt implements AsyncInterface
{
    /** TON request handle. */
    private TonRequest $_request;

    /**
     * AsyncResultOfEncryptionBoxDecrypt constructor.
     ...
     * @return ResultOfEncryptionBoxDecrypt Function execution result.
     * @throws TonClientException Function execution error.
     */
    public function await(int $timeout = -1): ResultOfEncryptionBoxDecrypt
    {
        return new ResultOfEncryptionBoxDecrypt($this->_request->await($timeout));
    }
