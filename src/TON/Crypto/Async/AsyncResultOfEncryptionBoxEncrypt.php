...
use TON\Crypto\ResultOfEncryptionBoxEncrypt;
use TON\JoinableInterface;
use TON\TonClientException;
use TON\TonRequest;

class AsyncResultOfEncryptionBoxEncrypt implements AsyncInterface
{
    /** TON request handle. */
    private TonRequest $_request;

    /**
     * AsyncResultOfEncryptionBoxEncrypt constructor.
     ...
     * @return ResultOfEncryptionBoxEncrypt Function execution result.
     * @throws TonClientException Function execution error.
     */
    public function await(int $timeout = -1): ResultOfEncryptionBoxEncrypt
    {
        return new ResultOfEncryptionBoxEncrypt($this->_request->await($timeout));
    }
