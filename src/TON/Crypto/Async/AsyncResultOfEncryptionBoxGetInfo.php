...
use TON\Crypto\ResultOfEncryptionBoxGetInfo;
use TON\JoinableInterface;
use TON\TonClientException;
use TON\TonRequest;

class AsyncResultOfEncryptionBoxGetInfo implements AsyncInterface
{
    /** TON request handle. */
    private TonRequest $_request;

    /**
     * AsyncResultOfEncryptionBoxGetInfo constructor.
     ...
     * @return ResultOfEncryptionBoxGetInfo Function execution result.
     * @throws TonClientException Function execution error.
     */
    public function await(int $timeout = -1): ResultOfEncryptionBoxGetInfo
    {
        return new ResultOfEncryptionBoxGetInfo($this->_request->await($timeout));
    }
