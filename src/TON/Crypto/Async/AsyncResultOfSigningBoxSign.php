...
use TON\Crypto\ResultOfSigningBoxSign;
use TON\JoinableInterface;
use TON\TonClientException;
use TON\TonRequest;

class AsyncResultOfSigningBoxSign implements AsyncInterface
{
    /** TON request handle. */
    private TonRequest $_request;

    /**
     * AsyncResultOfSigningBoxSign constructor.
     ...
     * @return ResultOfSigningBoxSign Function execution result.
     * @throws TonClientException Function execution error.
     */
    public function await(int $timeout = -1): ResultOfSigningBoxSign
    {
        return new ResultOfSigningBoxSign($this->_request->await($timeout));
    }
