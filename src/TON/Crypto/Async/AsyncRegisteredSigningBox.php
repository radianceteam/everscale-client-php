...
class AsyncRegisteredSigningBox implements EventsInterface, JoinableInterface
{
    /** TON request handle. */
    private TonRequest $_request;

    /**
     * AsyncRegisteredSigningBox constructor.
     ...
     * @return RegisteredSigningBox Function execution result.
     * @throws TonClientException Function execution error.
     */
    public function await(int $timeout = -1): RegisteredSigningBox
    {
        return new RegisteredSigningBox($this->_request->await($timeout));
    }
