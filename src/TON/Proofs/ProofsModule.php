...
use TON\Proofs\Async\AsyncProofsModule;
use TON\Proofs\Async\ProofsModuleAsyncInterface;
use TON\TonContext;

class ProofsModule implements ProofsModuleInterface
{
    ...
    /**
     * @return ProofsModuleAsyncInterface Async version of proofs module interface.
     */
    public function async(): ProofsModuleAsyncInterface
    {
        return new AsyncProofsModule($this->_context);
    }
     ...
     */
    public function proofBlockData(ParamsOfProofBlockData $params)
    {
        $this->_context->callFunction('proofs.proof_block_data', $params);
    }
