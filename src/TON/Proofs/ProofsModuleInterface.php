...
interface ProofsModuleInterface
{
     ...
     */
    function proofBlockData(ParamsOfProofBlockData $params);
     ...
     */
    function proofTransactionData(ParamsOfProofTransactionData $params);
     ...
     */
    function proofMessageData(ParamsOfProofMessageData $params);
}
