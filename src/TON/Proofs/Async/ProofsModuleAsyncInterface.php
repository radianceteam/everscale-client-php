...
interface ProofsModuleAsyncInterface
{
    /**
     ...
     * @return AsyncResult
     */
    function proofBlockDataAsync(ParamsOfProofBlockData $params): AsyncResult;
     ...
     * @return AsyncResult
     */
    function proofTransactionDataAsync(ParamsOfProofTransactionData $params): AsyncResult;
     ...
     * @return AsyncResult
     */
    function proofMessageDataAsync(ParamsOfProofMessageData $params): AsyncResult;
}
