...
namespace TON\Proofs\Async;

use TON\AsyncResult;
use TON\Proofs\ParamsOfProofBlockData;
use TON\Proofs\ParamsOfProofMessageData;
use TON\Proofs\ParamsOfProofTransactionData;
use TON\TonContext;

class AsyncProofsModule implements ProofsModuleAsyncInterface
{
    private TonContext $_context;

    /**
     * AsyncProofsModule constructor.
     ...
     * @return AsyncResult
     */
    public function proofBlockDataAsync(ParamsOfProofBlockData $params): AsyncResult
    {
        return new AsyncResult($this->_context->callFunctionAsync('proofs.proof_block_data', $params));
    }
     ...
     * @return AsyncResult
     */
    public function proofTransactionDataAsync(ParamsOfProofTransactionData $params): AsyncResult
    {
        return new AsyncResult($this->_context->callFunctionAsync('proofs.proof_transaction_data', $params));
    }
     ...
     * @return AsyncResult
     */
    public function proofMessageDataAsync(ParamsOfProofMessageData $params): AsyncResult
    {
        return new AsyncResult($this->_context->callFunctionAsync('proofs.proof_message_data', $params));
    }
}
